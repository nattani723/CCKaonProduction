...
class cckaon::NeutronScatterFilter : public art::EDFilter {
   public:
...
cckaon::NeutronScatterFilter::NeutronScatterFilter(fhicl::ParameterSet const& p)
   : EDFilter{p},
...
bool cckaon::NeutronScatterFilter::filter(art::Event& e)
{
   bool pass = true;
...
DEFINE_ART_MODULE(cckaon::NeutronScatterFilter)
