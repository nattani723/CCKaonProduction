...
class cckaon::K0SFilter : public art::EDFilter {
   public:
...
cckaon::K0SFilter::K0SFilter(fhicl::ParameterSet const& p)
   : EDFilter{p},
...
bool cckaon::K0SFilter::filter(art::Event& e)
{
...
DEFINE_ART_MODULE(cckaon::K0SFilter)
