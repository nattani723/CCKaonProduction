...
class cckaon::WireTreeMaker : public art::EDAnalyzer {
...
cckaon::WireTreeMaker::WireTreeMaker(fhicl::ParameterSet const& p)
   : EDAnalyzer{p}   // ,
...
void cckaon::WireTreeMaker::analyze(art::Event const& e)
{
...
void cckaon::WireTreeMaker::beginJob(){
...
void cckaon::WireTreeMaker::endJob()
{

}

void cckaon::WireTreeMaker::beginSubRun(const art::SubRun& sr)
{

}

void cckaon::WireTreeMaker::endSubRun(const art::SubRun& sr)
{

}

DEFINE_ART_MODULE(cckaon::WireTreeMaker)
