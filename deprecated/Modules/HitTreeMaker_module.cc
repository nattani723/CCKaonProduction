...
class cckaon::HitTreeMaker : public art::EDAnalyzer {
   public:
...
cckaon::HitTreeMaker::HitTreeMaker(fhicl::ParameterSet const& p)
   : EDAnalyzer{p}   // ,
...
void cckaon::HitTreeMaker::analyze(art::Event const& e)
{
...
void cckaon::HitTreeMaker::beginJob(){
...
void cckaon::HitTreeMaker::endJob()
{

}

void cckaon::HitTreeMaker::beginSubRun(const art::SubRun& sr)
{

}

void cckaon::HitTreeMaker::endSubRun(const art::SubRun& sr)
{

}

DEFINE_ART_MODULE(cckaon::HitTreeMaker)
