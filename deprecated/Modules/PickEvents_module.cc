...
class cckaon::PickEvents : public art::EDFilter {
	public:
...
cckaon::PickEvents::PickEvents(fhicl::ParameterSet const& p)
	: EDFilter{p}
...
bool cckaon::PickEvents::filter(art::Event& e)
{
...
void cckaon::PickEvents::beginJob()
{
...
void cckaon::PickEvents::endJob()
{
	// Implementation of optional member function here.
}

DEFINE_ART_MODULE(cckaon::PickEvents)
