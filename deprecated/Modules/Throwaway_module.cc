...
class cckaon::Throwaway : public art::EDAnalyzer {
   public:
...
cckaon::Throwaway::Throwaway(fhicl::ParameterSet const& p)
   : EDAnalyzer{p},
...
void cckaon::Throwaway::analyze(art::Event const& e)
{
  ...
  for(SimParticle cckaon : G4T.CCKaon){
    if((cckaon.PDG == 3112 || cckaon.PDG == 3222) && cckaon.ModMomentum > 0.4 && inActiveTPC(TVector3(cckaon.StartX,cckaon.StartY,cckaon.StartZ))){
      has_sigma = true;
    }
  }
...
void cckaon::Throwaway::beginJob(){
...
void cckaon::Throwaway::endJob()
{
}

void cckaon::Throwaway::beginSubRun(const art::SubRun& sr)
{
}

void cckaon::Throwaway::endSubRun(const art::SubRun& sr){}

DEFINE_ART_MODULE(cckaon::Throwaway)
