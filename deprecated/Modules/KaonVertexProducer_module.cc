...
class cckaon::KaonVertexProducer : public art::EDProducer {
   public:
...
cckaon::KaonVertexProducer::KaonVertexProducer(fhicl::ParameterSet const& p)
   : EDProducer{p},
...
void cckaon::KaonVertexProducer::produce(art::Event& e)
{
...
DEFINE_ART_MODULE(cckaon::KaonVertexProducer)
